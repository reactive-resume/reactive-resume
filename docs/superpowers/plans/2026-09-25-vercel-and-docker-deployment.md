...
- PNG-to-JPEG conversion and 1600×800-to-800×400 resizing passed on local disk, S3, and live Blob staging. Docker restart preserved the authenticated session, resume row, and local-volume image.
